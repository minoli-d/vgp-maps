...
for (i in seq_len(nrow(df_prioritized))) {
  ...
  if (file.exists(img_path)) {
    ...
    desc <- paste0(
      "\n\n### Species: ", sp, "\n\n",
      "**Common Name:** ", df_prioritized$english_name[i], "  \n",
      "**Biosample:** ", df_prioritized$biosample_accession[i], "  \n",
      "**Assembly Accession:** ", df_prioritized$accession_number_for_main_haplotype[i], "  \n",
      ...
      "\n\n**Map Notes:** ", df_prioritized$map_notes[i], "  \n",
      "**Comments:** ", df_prioritized$comments[i], "\n\n"
    )
    
    # print the species section to the Markdown
    cat(desc)
    cat("![](../species/", sp_sane, "/", sp_sane, "_distribution_map.png)\n", sep = "")
  }
}
